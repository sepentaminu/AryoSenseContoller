...
#endif
{
	...
	private bool customActivationRange = true;
	...
	void Start ()
	{
		joystickBase = GameObject.FindWithTag("JoyStickBase").GetComponent<RectTransform>();
		joystick = GameObject.FindWithTag("JoyStickHandle").GetComponent<RectTransform>();
